...
int main(int argc,char** argv)
{
	...
	NGOS_UIOBJECT_HANDLE hIcon = NGOS_CreateUIObject(NGOS_GetDefaultUIObjectTypeLoader(),"ImageObject","icon0");
	NGOS_ImageObjectSetImageID(hIcon,"image.icon0");
	RECT pos2 = {10,10,10+64,10+64};
	NGOS_SetUIObjectRect(hIcon,&pos2);

	NGOS_UIOBJECT_HANDLE hIcon2 = NGOS_CreateUIObject(NGOS_GetDefaultUIObjectTypeLoader(),"ImageObject","icon1");
	NGOS_ImageObjectSetImageID(hIcon2,"image.icon1");
	RECT pos3 = {78,10,78+64,10+64};
	NGOS_SetUIObjectRect(hIcon2,&pos3);

	NGOS_UIOBJECT_HANDLE hIcon3 = NGOS_CreateUIObject(NGOS_GetDefaultUIObjectTypeLoader(),"ImageObject","icon2");
	...
	NGOS_UIOBJECT_HANDLE hIcon4 = NGOS_CreateUIObject(NGOS_GetDefaultUIObjectTypeLoader(),"ImageObject","icon3");
